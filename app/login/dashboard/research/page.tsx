          ...
          <table className="w-full border-collapse min-w-[800px] lg:min-w-full">
            <thead>
              <tr className="bg-slate-50/50 text-left border-b border-slate-100">
                ...
                <th className="px-4 md:px-8 py-4 md:py-5 text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">Journal & DOI</th>
                ...
                <tr key={item.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-4 md:px-8 py-4 md:py-6">
                    <div className="text-xs md:text-sm">
                      <p className="text-slate-600 font-medium mb-0.5 md:mb-1">{item.journal}</p>
                      <p className="text-[10px] md:text-xs text-slate-400 font-mono tracking-tight">{item.doi}</p>
                    </div>
                  </td>
