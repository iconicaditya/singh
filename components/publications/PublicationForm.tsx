        ...
        <form onSubmit={handleSubmit} className="p-4 md:p-8 space-y-4 md:space-y-6 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 md:px-5 py-3 md:py-4 bg-slate-50 border border-slate-100 rounded-xl md:rounded-2xl focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium"
              placeholder="e.g. environment, sustainability (comma separated)"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-col gap-4">
              <div 
                ...
                className="border-2 border-dashed border-slate-200 rounded-xl md:rounded-2xl p-4 md:p-8 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-blue-400 hover:bg-blue-50/50 transition-all group"
              >
                {pdfUrl ? (
                  <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-100 w-full">
                    ...
                    <Upload className="text-blue-400 group-hover:text-blue-600" size={20} />
                  </div>
                ) : (
                  <>
                    ...
                    <p className="text-xs md:text-sm font-bold text-slate-600">Click to upload PDF</p>
                  </>
                )}
                <input 
                  type="file" 
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-slate-50 border border-slate-100 rounded-lg focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none font-medium text-[11px]"
          ...
          <div className="space-y-2">
            <label className="text-[10px] md:text-xs font-black uppercase tracking-widest text-slate-400">Short Description (Max 25 words)</label>
            <textarea
              name="description"
